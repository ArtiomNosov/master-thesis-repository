...
- графики качества, распределений дрейфа, задержки/пропускной способности и эффекта для рекрутера;
...
- реалистичные данные для `ранжирование_резюме_3`, `скоринг_соответствия_2`, `сортировка_откликов_1`, `извлечение_навыков_4`.
