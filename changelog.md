...
- Экономический раздел ВКР оформлен через буквенные формулы, расшифровку переменных и расчетные подстановки.
- В презентационных источниках название исходного агрегатора заменено на нейтральную формулировку «агрегатор вакансий и резюме».
...
- Нейтрализованы упоминания source platform; термины «независимый энкодер (bi-encoder)».
