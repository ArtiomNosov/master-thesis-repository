...
COMMON_REPLACEMENTS = [
    ("агрегатора source platform", "агрегатора вакансий"),
    ("из агрегатора source platform", "из агрегатора вакансий"),
    ("данных source platform", "данных агрегатора вакансий"),
    ("source platform", "агрегатор вакансий"),
    ("data/source platform", "каталога данных агрегатора"),
    ("DCNG@", "NDCG@"),
]
...
def patch_markdown() -> None:
    md_replacements = DOCX_REPLACEMENTS + [
        ...
        ("(source platform)", "(каталог данных агрегатора)"),
        ("source platform", "каталога данных агрегатора"),
        ("#source platform", ""),
