...
|  | **Теоретическая часть. Данные и требования к их обработке** |  |  |  |
|  | Выполнение сбора, профилирования, очистки и разметки исходных данных (вакансии и резюме) | Набор данных (Dataset) | 4 |  |
|  | Требования к конвейеру предварительной обработки и модулю вычисления семантической близости | Описание архитектуры | 4 |  |
