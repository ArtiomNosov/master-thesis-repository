...
Проверка форматирования выполняется программно по структуре DOCX; визуальная оценка не используется. Чекер падает, если таблица не имеет подписи над таблицей или рисунок не имеет подписи под рисунком. Если в Markdown перед таблицей нет подписи `Таблица N – ...`, конвертер добавляет ее автоматически на основе заголовков таблицы.
