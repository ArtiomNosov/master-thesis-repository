...
def main():
    parser = argparse.ArgumentParser(description="Build event-driven matched samples from raw source platform TSV files.")
    root = repo_root()
    parser.add_argument("--data_dir", type=Path, default=root / "data" / "source platform")
