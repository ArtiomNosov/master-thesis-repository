...
CHAPTER3_SECTIONS = [
    "Проектирование и разработка программного контура подготовки данных и конвейера машинного обучения",
    (
...
def main() -> None:
    ...
    write_chapter(
        ...
        "\\chapter{Проектирование, разработка и реализация модуля, который семантически сопоставляет вакансии и резюме, рассчитывает оценку соответствия в доменном векторном пространстве и ранжирует кандидатов на вакансию}",
        "chapter:impl",
        "В главе представлены проектирование программного контура подготовки данных и ML-конвейера, реализация и дообучение модели сопоставления текст вакансии и текст резюме, структура сохранённого артефакта, реализация класса \\texttt{ATSRanker} и FastAPI-сервиса.",
        CHAPTER3_SECTIONS,
        sections,
    )
