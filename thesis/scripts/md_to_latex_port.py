...
CHAPTER1_SECTIONS = [
    ...
    ("Выводы по первому разделу", "Выводы по первому разделу"),
    "Постановка задачи",
]
...
CHAPTER2_SECTIONS = [
    ...
    ("Выводы по второму разделу", "Выводы по второму разделу"),
]
...
CHAPTER3_SECTIONS = [
    ...
    ("Выводы по третьему разделу", "Выводы по третьему разделу"),
...
CHAPTER4_SECTIONS = [
    ...
    ("Выводы по четвертому разделу", "Выводы по четвертому разделу"),
]
