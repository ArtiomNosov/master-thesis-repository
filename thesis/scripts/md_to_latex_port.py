...
def main() -> None:
    ...
    write_chapter(
        ...
        "chapter:impl",
        "В главе описаны программный контур подготовки данных и ML-конвейер, реализация и дообучение модели сопоставления текст вакансии и текст резюме, структура сохранённого артефакта, реализация класса \\texttt{ATSRanker} и FastAPI-сервиса.",
        CHAPTER3_SECTIONS,
        sections,
    )
